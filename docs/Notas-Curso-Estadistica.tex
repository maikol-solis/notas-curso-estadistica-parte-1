...
\textbf{Observación}: El parámetro \(\theta\) contiene la información del modelo,
...
\hypertarget{ejemplo-clientes-de-un-banco}{%
\subsection{Ejemplo: clientes de un banco}\label{ejemplo-clientes-de-un-banco}}
