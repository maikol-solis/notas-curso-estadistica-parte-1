...
Recuerde que, para $X_1,\dots, X_n \stackrel{i.i.d}{\sim} f(X|\theta)$ con $\theta$ fijo, la **función de verosimilitud** se define como
...
**Ejemplo**. $X_1,\dots, X_n \stackrel{i.i.d}{\sim} \text{Unif}(0)$. Estime $\theta$ $(\theta > 0)$. Suponga que $x_i>0 \forall i$.
...
**Definicion (Generalización del MLE)**. Si $g$ es una función de $\theta$ y $G$ la imagen de $\Omega$ bajo $g$. Para cada $t\in G$ defina
$$ G_t = \{\theta: g(\theta) = t\}$$
